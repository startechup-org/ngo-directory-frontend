...
const Form = (props) => {
	...
	if (props.activeRecord.action === 'Delete') {
		return (
			<p>
				Are you sure you want to delete {props.activeRecord.type}{' '}
				{props.activeRecord.data.org_name || props.activeRecord.data.name}?
			</p>
		);
	}
...
export default function AdminDashboard() {
	...
	const handleSubmit = (e) => {
		...
		if (activeRecord.type === 'user' && activeRecord.action === 'Edit') {
		...
		if (activeRecord.type === 'user' && activeRecord.action === 'Delete') {
